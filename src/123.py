...
class Planner:
    ...
    def domain_problem_path(self, rel_d_path, rel_p_path):
    ...
    def create_tempsrc(self):
        print(self.planner_src_folder_name)
        print(self.planner_name)
...
class PRP(Planner):
    ...
    def get_command(self, rel_d_path, rel_p_path):
        command=f"./prp {super().domain_problem_path(rel_d_path, rel_p_path)} --dump-policy 2"
        return command
...
class SAT(Planner):
    ...
    def get_command(self, rel_d_path, rel_p_path):
        command=f"python main.py {super().domain_problem_path(rel_d_path, rel_p_path)}"
        return command
...
if __name__ == '__main__':
    planner_instance = SAT()
    planner_instance.create_tempsrc()